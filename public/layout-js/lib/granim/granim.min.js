        ...
        1: [
            function (t, e, s) {
                ...
                function i(t) {
                    this.getElement(t.element),
                        ...
                        (this.isPausedWhenNotInView =
                            t.isPausedWhenNotInView || !1),
                        (this.opacity = t.opacity),
                        (this.states = t.states),
                        (this.stateTransitionSpeed =
                            t.stateTransitionSpeed || 1e3),
                        ...
                        (this.activeState =
                            t.defaultStateName || 'default-state'),
                        ...
                        (this.callbacks = {
                            ...
                            onGradientChange:
                                'function' == typeof t.onGradientChange &&
                                t.onGradientChange,
                ...
                ;(i.prototype.setColors = t('./setColors.js')),
                    ...
                    (i.prototype.getElement = t('./getElement.js')),
                    ...
                    (i.prototype.pauseWhenNotInView = t(
                        './pauseWhenNotInView.js'
                    )),
            ...
            function (t, e, s) {
                ...
                e.exports = function (t) {
                    ...
                    ;(null === this.previousTimeStamp || n) &&
                        ...
                        (this.progress =
                            this.progress + (t - this.previousTimeStamp)),
                        (e = (
                            (this.progress / this.activetransitionSpeed) *
                            100
                        ).toFixed(2)),
                        (this.previousTimeStamp = t),
        ...
        9: [
            function (t, e, s) {
                ...
                e.exports = function (t) {
                    ...
                    if (!this.canvas)
                        throw new Error(
                            '`' + t + '` could not be found in the DOM'
                        )
                }
            },
            {},
                ...
                e.exports = function () {
                    ...
                    this.name &&
                        ('light' === this.getLightness()
                            ? (i.remove(this.name + '-dark'),
                              i.add(this.name + '-light'))
                            : (i.remove(this.name + '-light'),
                              i.add(this.name + '-dark'))),
                ...
                e.exports = function () {
                    ...
                    return (
                        this.channels[this.activeState] ||
                            (this.channels[this.activeState] = []),
                        void 0 !==
                        this.channels[this.activeState][this.channelsIndex]
                            ? ((this.activeColors =
                                  this.channels[this.activeState][
                                      this.channelsIndex
                                  ].colors),
                              void (this.activeColorDiff =
                                  this.channels[this.activeState][
                                      this.channelsIndex
                                  ].colorsDiff))
                            : (this.channels[this.activeState].push([{}]),
                              ...
                              this.states[this.activeState].gradients[
                                  ...
                                  r[s.channelsIndex].colors.push(a),
                                      ...
                                      s.iscurrentColorsSet ||
                                          s.currentColors.push(s.hexToRgb(i)),
                                      s.channelsIndex ===
                                      s.states[s.activeState].gradients.length -
                                          1
                                          ? (t = s.colorDiff(
