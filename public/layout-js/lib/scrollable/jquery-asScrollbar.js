                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function is(state) {
                            return (
                                this._states[state] && this._states[state] > 0
                            )
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function eventName(events) {
                            ...
                            for (var _i = 0; _i < length; _i++) {
                                events[_i] =
                                    events[_i] + '.' + this.options.namespace
                            }
                                ...
                                this.$bar.on(
                                    ...
                                    function (e) {
                                        ...
                                        if (offset <= 0 && delta > 0) {
                                            ...
                                            offset >= _this.barLength &&
                                            delta < 0
                                        ) {
                                            return true
                                        }
                                        offset -=
                                            _this.options.mousewheelSpeed *
                                            delta
                    ...
                    },
                    {
                        ...
                        value: function onClick(event) {
                            ...
                            if (
                                distance >
                                this.barLength * this.options.clickMoveStep
                            ) {
                                distance =
                                    this.barLength * this.options.clickMoveStep
                            }
                    ...
                    },
                    {
                        ...
                        value: function onDragStart(event) {
                            ...
                            if (this.options.pointerDrag && support.pointer) {
                                ;(0, _jquery2.default)(document).on(
                                    this.eventName(
                                        support.prefixPointerEvent('pointerup')
                                    ),
                                    _jquery2.default.proxy(this.onDragEnd, this)
                                )
                    ...
                    },
                    {
                        ...
                        value: function doMove(
                            ...
                            if (
                                this.options.useCssTransitions &&
                                support.transition
                            ) {
                    ...
                    },
                    {
                        ...
                        value: function setDefaults(options) {
                            _jquery2.default.extend(
                                DEFAULTS,
                                _jquery2.default.isPlainObject(options) &&
                                    options
                            )
                        },
                    },
                    ...
                    if (/^_/.test(method)) {
                        ...
                        return {
                            v: _this4.each(function () {
                                var instance = _jquery2.default.data(
                                    this,
                                    NAMESPACE
                                )
