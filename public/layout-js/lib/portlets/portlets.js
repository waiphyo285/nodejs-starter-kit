...
$.fn.enableSelection = function () {
    return this.removeAttr('unselectable')
...
$(function () {
    ...
    LobiPanel.prototype = {
        ...
        _init: function () {
            ...
            var maxWidth =
                'calc(100% - ' +
                me.$heading.find('.dropdown-menu').children().length *
                    me.$heading.find('.dropdown-menu li').first().outerWidth() +
                'px)'
        ...
        unpin: function () {
            ...
            if (me.$el.attr('old-style')) {
                ...
                var left = Math.max(
                    0,
                    ($(window).width() - me.$el.outerWidth()) / 2
                )
                var top = Math.max(
                    0,
                    $(document).scrollTop() +
                        ($(window).height() - me.$el.outerHeight()) / 2
                )
                me.$el.css({
                    left: left,
                    top: top,
        ...
        isMinimized: function () {
            var me = this
            return (
                me.$el.hasClass('panel-minimized') ||
                me.$el.hasClass('panel-collapsed')
            )
        },
        ...
        minimize: function () {
            ...
            if (me.isPinned()) {
                ...
                me._changeClassOfControl(
                    me.$heading.find('[data-func="minimize"]')
                )
            } else {
                me.disableTooltips()
                ...
                me.$el.animate(
                    ...
                    function () {
                        ...
                        if (me.$el.hasClass('panel-expanded')) {
                            ...
                            me.$el
                                .find(
                                    '.panel-heading [data-func=expand] .' +
                                        LobiPanel.PRIVATE_OPTIONS.iconClass
                                )
                        ...
                        var maxWidth =
                            'calc(100% - ' +
                            me.$heading.find('.dropdown-menu li>a:visible')
                                .length *
                                me.$heading
                                    .find('.dropdown-menu li>a:visible')
                                    .first()
                                    .outerWidth() +
                            'px)'
                        me.$heading
        ...
        maximize: function () {
            ...
            if (me.isPinned()) {
                ...
                me.$el.animate(css, 100, function () {
                    ...
                    $('body')
                        .removeClass('lobipanel-minimized')
                        .addClass('lobipanel-minimized')
                    var maxWidth =
                        'calc(100% - ' +
                        me.$heading.find('.dropdown-menu li').length *
                            me.$heading
        ...
        close: function (animationDuration) {
            var me = this,
                animationDuration =
                    animationDuration === undefined ? 100 : animationDuration
        ...
        startTitleEditing: function () {
            ...
            input[0].select()
            me._changeClassOfControl(
                me.$heading.find('[data-func="editTitle"]')
            )
            return me
        },
        ...
        enableTooltips: function () {
            ...
            controls.each(function (ind, el) {
                $(el).tooltip({
                    container: 'body',
                    template:
                        '<div class="tooltip lobipanel-tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
                })
            })
            return me
        },
        ...
        _generateDropdown: function () {
            ...
            return $('<div class="dropdown"></div>')
                ...
                .append(
                    '<div class="dropdown-toggle" data-toggle="dropdown"><span class="' +
                        LobiPanel.PRIVATE_OPTIONS.iconClass +
                        ' ' +
                        me.$options.toggleIcon +
                        '"></div>'
                )
        },
        _generateEditTitle: function () {
            ...
            if (options.tooltip && typeof options.tooltip === 'string') {
                control.append(
                    '<span class="control-title">' + options.tooltip + '</span>'
                )
        ...
        _changeClassOfControl: function (el) {
            ...
            el.find('.' + LobiPanel.PRIVATE_OPTIONS.iconClass)
        ...
        _getFooterForMinimizedPanels: function () {
            ...
            if (minimizedCtr.length === 0) {
                minimizedCtr = $(
                    '<div class="' +
                        LobiPanel.PRIVATE_OPTIONS.toolbarClass +
                        '"></div>'
                )
        ...
        _calculateBodyHeight: function (h) {
            ...
            return (
                h -
                me.$heading.outerHeight() -
                me.$el.find('.panel-footer').outerHeight()
            )
        },
        ...
        _appendInnerIdToParent: function (parent, innerId) {
            ...
            if (
                parent.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr) === undefined
            ) {
            ...
            //This means that parent already has LobiPanel instance
                ...
                if (
                    parent
                        .attr(LobiPanel.PRIVATE_OPTIONS.parentAttr)
                        .indexOf(innerId) > -1
                ) {
                    return
                }
                ...
                parent.attr(
                    LobiPanel.PRIVATE_OPTIONS.parentAttr,
                    innerIds + ' ' + innerId
                )
            }
        ...
        _generateWindow8Spinner: function () {
            var me = this
            var template = [
                '<div class="spinner spinner-windows8">',
                '<div class="wBall">',
        ...
        _updateDataIndices: function (panel) {
            ...
            items.each(function (index, el) {
                ...
                if (
                    lobiPanel &&
                    lobiPanel.$options.stateful &&
                    !lobiPanel.hasRandomId
                ) {
        ...
        _triggerEvent: function (eventType) {
            ...
            if (
                me.$options[eventType] &&
                typeof me.$options[eventType] === 'function'
            ) {
