d3 = (function () {
    ...
    function dt() {
        var n = mt(),
            t = vt() - n
        t > 24
            ? (isFinite(t) && (clearTimeout(lo), (lo = setTimeout(dt, t))),
              (co = 0))
            : ((co = 1), fo(dt))
    }
    function mt() {
        ...
        for (var l = 0, f = t.length; f > l; ++l) {
            ...
            if (h) {
                for (
                    ...
                    if (
                        (So.add(
                            Math.atan2(E * Math.sin(w), v * _ + E * Math.cos(w))
                        ),
                        Math.abs(x) < $a && (o = !0),
                        (u += S ? w + (w >= 0 ? 2 : -2) * Ba : w),
                        S ^ (p >= e) ^ (M >= e))
        ...
        return function (c) {
            ...
            function f(n) {
                for (var t = 0, e = M.length, r = n[1], i = 0; e > i; ++i)
                    for (
                        var u, a = 1, o = M[i], c = o.length, l = o[0];
                        c > a;
                        ++a
                    )
                        (u = o[a]),
    ...
    function we(n, t) {
        ...
        return function (i, u, a, o) {
            ...
            for (var c, l = a * t, f = i; a > 0 ? f > u : u > f; f -= l)
                o.point(
                    (c = Dt([e, -r * Math.cos(f), -r * Math.sin(f)]))[0],
                    c[1]
                )
        }
    }
    ...
    function Te() {
        function n(n, i) {
            ...
            ;(Jo += Math.atan2(
                Math.sqrt(
                    (o = a * Math.sin(o)) * o + (o = r * u - e * a * c) * o
                ),
                e * u + r * a * c
            )),
                (t = n),
    ...
    function ze(n, t) {
        function e(n, t) {
            var e =
                Math.abs(Math.abs(t) - Ba / 2) < $a ? 0 : a / Math.pow(i(t), u)
    ...
    function Xe(n, t) {
        return n.length < 4
            ? Re(n)
            : n[1] + $e(n.slice(1, n.length - 1), We(n, t))
    }
    function Ze(n, t) {
        return n.length < 3
            ? Re(n)
            : n[0] +
                  $e(
                      (n.push(n[0]), n),
                      We([n[n.length - 2]].concat(n, [n[1]]), t)
                  )
    }
    function Be(n, t) {
    ...
    function Ke(n) {
        for (
            var t, e, r = -1, i = n.length, u = i + 4, a = [], o = [];
            ++r < 4;
    ...
    function ir(n) {
        for (
            var t, e, r, i, u = [], a = rr(n), o = -1, c = n.length - 1;
            ++o < c;
                ...
                insert: function (n, t, e) {
                    ...
                    for (var r = 0, i = u.list, a = i.length; a > r; r++) {
                        ...
                        if (
                            !(
                                n.ystar > o.ystar ||
                                (n.ystar == o.ystar && t.x > o.vertex.x)
                            )
                        )
                            break
                    }
        ...
        for (
            ...
            if (((a = f[r]), a.x == e[0])) {
                if (a.i)
                    if (null == l[a.i + 1])
                        for (
                            l[a.i - 1] += a.x, l.splice(a.i, 1), i = r + 1;
                            u > i;
                            ++i
                        )
                            f[i].i--
    ...
    function Hr(n, t) {
        ...
        return (
            ...
            function (r) {
                return (
                    1 +
                    n * Math.pow(2, 10 * -r) * Math.sin((2 * (r - e) * Ba) / t)
                )
            }
        )
    }
    ...
    function Eu(n, t, e, r) {
        ...
        return q(
            ...
            'function' == typeof e
                ? function (n, u, a) {
                      n.__transition__[i].tween.set(
                          t,
                          r(e.call(n, n.__data__, u, a))
                      )
                  }
                : ((e = r(e)),
                  function (n) {
                ...
                va.timer(
                    function (r) {
                        ...
                        function c(r) {
                            ...
                            for (
                                var i = (r - g) / p, a = s(i), o = d.length;
                                o > 0;

                            )
                                d[--o].call(n, a)
                            return i >= 1
                                ? (l(), h.end.call(n, f, t), 1)
                                : void 0
                        }
                        function l() {
                            return (
    ...
    function ju(n, t, e, r) {
        for (var i, u, a = 0, o = t.length, c = e.length; o > a; ) {
            ...
            if (((i = t.charCodeAt(a++)), 37 === i)) {
                if (((u = il[t.charAt(a++)]), !u || (r = u(n, e, r)) < 0))
                    return -1
    ...
    ;(va.bisectLeft = Sa.left),
        ...
        (va.zip = function () {
            ...
            for (
                var n = -1, e = va.min(arguments, t), r = new Array(e);
                ++n < e;
    ...
    ;(va.dispatch = function () {
        ...
        (s.prototype.on = function (n, t) {
            var e = n.indexOf('.'),
                r = ''
            if (
                (e >= 0 && ((r = n.substring(e + 1)), (n = n.substring(0, e))),
                n)
            )
        ...
        (Ha.selectAll = function (n) {
            ...
            for (var i = -1, u = this.length; ++i < u; )
                for (var a = this[i], o = -1, c = a.length; ++o < c; )
                    (e = a[o]) &&
                        (r.push((t = Na(n.call(e, e.__data__, o)))),
                        (t.parentNode = e))
            return m(r)
        })
    var Fa = {
    ...
    ;(va.selection.enter = T),
        ...
        (Pa.select = function (n) {
            for (
                var t, e, r, i, u, a = [], o = -1, c = this.length;
                ++o < c;
                ...
                for (var l = -1, f = i.length; ++l < f; )
                    (u = i[l])
                        ? (t.push(
                              (r[l] = e = n.call(i.parentNode, u.__data__, l))
                          ),
            ...
            function t() {
                ...
                function i() {
                    g
                        ...
                        .on(
                            null != l ? 'touchend.drag-' + l : 'mouseup.drag',
                            null
                        ),
                ...
                var u,
                    ...
                    c = va.event.target,
                    l = va.event.touches
                        ? va.event.changedTouches[0].identifier
                        : null,
                    f = n(),
                    s = 0,
        ...
        (va.behavior.zoom = function () {
            ...
            function f() {
                ...
                r(
                    Math.pow(
                        2,
                        va.event.shiftKey ? Math.ceil(u) - 1 : Math.floor(u) + 1
                    )
                ),
                    i(n, e),
                    a(E.of(this, arguments))
    ...
    var Yo,
        ...
        Bo = {
            ...
            polygonEnd: function () {
                ;(Bo.lineStart = Bo.lineEnd = Bo.point = f),
                    (Yo += Math.abs(Uo / 2))
            },
        },
        $o = {
    ...
    ;(va.geo.path = function () {
        function n(n) {
            return (
                n &&
                    ('function' == typeof o &&
                        u.pointRadius(+o.apply(this, arguments)),
                    (a && a.valid) || (a = i(u)),
                    va.geo.stream(n, a)),
                u.result()
            )
        ...
        (va.geo.rotation = function (n) {
            function t(t) {
                return (
                    (t = n(t[0] * Ja, t[1] * Ja)), (t[0] *= Ga), (t[1] *= Ga), t
                )
            }
            return (
                (n = Me(
        ...
        (va.layout.force = function () {
            ...
            return (
                (o.tick = function () {
                    ...
                    for (e = 0; _ > e; ++e)
                        (o = v[e]),
                            ...
                            (d = M * M + x * x) &&
                                ((d =
                                    (r * u[e] * ((d = Math.sqrt(d)) - i[e])) /
                                    d),
                                (M *= d),
                                (x *= d),
                                (h.x -=
                                    M * (y = s.weight / (h.weight + s.weight))),
                                (h.y -= x * y),
                                (s.x += M * (y = 1 - y)),
                                (s.y += x * y))
                    if (
                        (y = r * p) &&
                        ((M = l[0] / 2), (x = l[1] / 2), (e = -1), y)
                    )
                        for (; ++e < b; )
                            (o = m[e]),
                                (o.x += (M - o.x) * y),
                    ...
                    if (g)
                        for (
                            Kr((t = va.geom.quadtree(m)), r, a), e = -1;
                            ++e < b;
                ...
                (o.start = function () {
                    ...
                    for (e = 0; d > e; ++e)
                        (f = v[e]),
                            'number' == typeof f.source &&
                                (f.source = m[f.source]),
                            'number' == typeof f.target &&
                                (f.target = m[f.target]),
                            ++f.source.weight,
                            ++f.target.weight
                    for (e = 0; p > e; ++e)
    ...
    va.layout.stack = function () {
        function n(o, c) {
            ...
            for (g = 0; v > g; ++g)
                for (
                    i.call(n, l[0][g], (p = d[g]), f[0][g][1]), h = 1;
                    m > h;
                    ++h
                )
            ...
            function n(n, u) {
                ...
                function c(n, t, r) {
                    if (t) {
                        ...
                        o &&
                            !vi(a) &&
                            ((a._tree.thread = o), (a._tree.mod += s - f)),
                            u &&
                                !mi(c) &&
                                ((c._tree.thread = u),
                                (c._tree.mod += l - h),
        ...
        (va.layout.pack = function () {
            function n(n, u) {
                ...
                if (
                    ...
                    var s =
                        (r * (t ? 1 : Math.max((2 * o.r) / c, (2 * o.r) / l))) /
                        2
                    _i(o, function (n) {
                        n.r += s
                    }),
                    ...
                    var a,
                        ...
                        d =
                            'slice' === g
                                ...
                                : Math.min(l.dx, l.dy)
                    for (
                        n(h, (l.dx * l.dy) / e.value), f.area = 0;
                        (c = h.length) > 0;
                        ...
                        f.push((a = h[c - 1])),
                            ...
                            'squarify' !== g || (o = r(f, d)) <= p
                                ...
                                : ((f.area -= f.pop().area),
                                  ...
                                  (f.length = f.area = 0),
                                  (p = 1 / 0))
                    f.length && (i(f, d, l, !0), (f.length = f.area = 0)),
                        u.forEach(t)
                }
            }
            function e(t) {
                ...
                if (r && r.length) {
                    var u,
                        ...
                        c = []
                    for (
                        n(o, (a.dx * a.dy) / t.value), c.area = 0;
                        (u = o.pop());
                ...
                if (t == e.dx) {
                    for ((r || f > e.dy) && (f = e.dy); ++u < a; )
                        (i = n[u]),
                            ...
                            (i.dy = f),
                            (o += i.dx =
                                Math.min(e.x + e.dx - o, f ? c(i.area / f) : 0))
                    ;(i.z = !0),
                        (i.dx += e.x + e.dx - o),
                        (e.y += f),
                        (e.dy -= f)
                    ...
                    for ((r || f > e.dx) && (f = e.dx); ++u < a; )
                        (i = n[u]),
                            ...
                            (i.dx = f),
                            (l += i.dy =
                                Math.min(e.y + e.dy - l, f ? c(i.area / f) : 0))
                    ;(i.z = !1),
                        (i.dy += e.y + e.dy - l),
                        (e.x += f),
                        (e.dx -= f)
    ...
    ;(va.scale.linear = function () {
        ...
        (va.scale.log = function () {
            return nu(
                va.scale.linear().domain([0, Math.LN10]),
                10,
                tu,
                eu,
                [1, 10]
    ...
    va.svg.brush = function () {
        function n(u) {
            u.each(function () {
                ...
                a
                    ...
                    o &&
                        ((u = Ui(o)),
                        f.attr('x', u[0]).attr('width', u[1] - u[0]),
                        e(a)),
                    c &&
                        ((u = Ui(c)),
                        f.attr('y', u[0]).attr('height', u[1] - u[0]),
                        r(a)),
                    t(a)
            })
        }
        ...
        return (
            ...
            (n.clear = function () {
                return (
                    (u = null), (f[0][0] = f[0][1] = f[1][0] = f[1][1] = 0), n
                )
            }),
            (n.empty = function () {
        ...
        Pc.forEach(function (n, t) {
            ...
            var e = (va.time[n] = zu(
                ...
                function (n) {
                    ...
                    return (
                        Math.floor((va.time.dayOfYear(n) + ((e + t) % 7)) / 7) -
                        (e !== t)
                    )
                }
            ))
            ...
            function t(t) {
                for (var r, i, u, a = [], o = -1, c = 0; ++o < e; )
                    37 === n.charCodeAt(o) &&
                        ...
                        null != (i = el[(r = n.charAt(++o))]) &&
                            (r = n.charAt(++o)),
                        (u = rl[r]) &&
                            (r = u(t, null == i ? ('e' === r ? ' ' : '0') : i)),
                        a.push(r),
                        (c = o + 1))
