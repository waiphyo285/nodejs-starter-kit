        ...
        function BarRating() {
            ...
            var buildWidget = function () {
                ...
                if (self.options.showSelectedRating) {
                    $w.append(
                        $('<div />', { text: '', class: 'br-current-rating' })
                    )
                }
            ...
            var applyStyle = function () {
                ...
                // add classes
                $a.addClass('br-selected br-current')
                ...
                if (!getData('ratingMade') && $.isNumeric(initialRating)) {
                    ...
                    $fractional = $a.length
                        ...
                        : $all[
                              getData('userOptions').reverse ? 'last' : 'first'
                          ]()
            ...
            this.set = function (value) {
                ...
                if (
                    self.$elem.find('option[value="' + value + '"]').length ===
                    0
                )
                    return
    ...
    $.fn.barrating = function (method, options) {
        return this.each(function () {
            ...
            if (plugin.hasOwnProperty(method)) {
                ...
                $.error(
                    'Method ' + method + ' does not exist on jQuery.barrating'
                )
            }
        })
    }
