...
;(function webpackUniversalModuleDefinition(root, factory) {
	...
	*/
                    ...
                    var Holder = {
                        ...
                        run: function (userOptions) {
                            ...
                            App.vars.dataAttr =
                                options.dataAttr || App.setup.dataAttr
                            ...
                            var stylenodes = DOM.getNodeArray(
                                options.stylenodes
                            )
                            ...
                            engineSettings.noFontFallback =
                                !!options.noFontFallback
                            engineSettings.noBackgroundSize =
                                !!options.noBackgroundSize

                            stylenodes.forEach(function (styleNode) {
                                if (
                                    styleNode.attributes.rel &&
                                    styleNode.attributes.href &&
                                    styleNode.attributes.rel.value ==
                                        'stylesheet'
                                ) {
                                    ...
                                    var stylesheetURL =
                                        ...
                                        proxyLink.pathname +
                                        proxyLink.search
                                    engineSettings.stylesheets.push(
                                        stylesheetURL
                                    )
                                }
                            })
                            ...
                            bgnodes.forEach(function (bgNode) {
                                ...
                                var holderStringIndex =
                                    rawURL.indexOf(holderString)
                            ...
                            objects.forEach(function (object) {
                                ...
                                try {
                                    ...
                                    objectAttr.dataSrc = object.getAttribute(
                                        App.vars.dataAttr
                                    )
                                } catch (e) {}
                                ...
                                var objectHasSrcURL =
                                    ...
                                    objectAttr.data.indexOf(options.domain) ===
                                        0
                                var objectHasDataSrcURL =
                                    objectAttr.dataSrc != null &&
                                    objectAttr.dataSrc.indexOf(
                                        options.domain
                                    ) === 0
                            ...
                            images.forEach(function (image) {
                                ...
                                try {
                                    ...
                                    imageAttr.dataSrc = image.getAttribute(
                                        App.vars.dataAttr
                                    )
                                ...
                                var imageHasDataSrcURL =
                                    ...
                                    imageAttr.dataSrc.indexOf(
                                        options.domain
                                    ) === 0
                                var imageRendered =
                                    imageAttr.rendered != null &&
                                    imageAttr.rendered == 'true'

                                if (imageHasSrc) {
                                    if (
                                        imageAttr.src.indexOf(
                                            options.domain
                                        ) === 0
                                    ) {
                                        prepareImageElement(
                    ...
                    function parseURL(url, instanceOptions) {
                        ...
                        if (parts.length === 2) {
                            ...
                            if (utils.truthy(options.ratio)) {
                                ...
                                ratioHeight = Math.floor(
                                    100 * (ratioHeight / ratioWidth)
                                )
                                ratioWidth = 100
                            ...
                            if (
                                options.theme &&
                                holder.instanceOptions.themes.hasOwnProperty(
                                    options.theme
                                )
                            ) {
                                holder.theme = extend(
                            ...
                            if (utils.truthy(options.random)) {
                                ...
                                var _theme =
                                    App.vars.cache.themeKeys[
                                        0 |
                                            (Math.random() *
                                                App.vars.cache.themeKeys.length)
                                    ]
                                holder.theme = extend(
                    ...
                    function prepareDOMElement(prepSettings) {
                        ...
                        if (flags.text != null) {
                            ...
                            if (el.nodeName.toLowerCase() === 'object') {
                                ...
                                for (var k = 0; k < textLines.length; k++) {
                                    textLines[k] = utils.encodeHtmlEntity(
                                        textLines[k]
                                    )
                                }
                        ...
                        if (theme.text) {
                            var holderTemplateMatches =
                                theme.text.match(holderTemplateRe)

                            if (holderTemplateMatches !== null) {
                                //todo: optimize template replacement
                                holderTemplateMatches.forEach(function (match) {
                                    if (match === 'holder_dimensions') {
                                        theme.text = theme.text.replace(
                                            match,
                                            dimensionsCaption
                                        )
                                    }
	        ...
	        */
                        ...
                        if (mode == 'background') {
                            if (
                                el.getAttribute('data-background-src') == null
                            ) {
                                DOM.setAttr(el, {
                    ...
                    function buildSceneGraph(scene) {
                        ...
                        scene.font = {
                            ...
                            units: scene.theme.units
                                ? scene.theme.units
                                : App.defaults.units,
                            weight: scene.theme.fontweight
                                ? scene.theme.fontweight
                                : 'bold',
                        }

                        scene.text =
                            scene.theme.text ||
                            Math.floor(scene.width) +
                                'x' +
                                Math.floor(scene.height)

                        scene.noWrap = scene.theme.nowrap || scene.flags.nowrap

                        scene.align =
                            scene.theme.align || scene.flags.align || 'center'
                        ...
                        switch (scene.flags.textmode) {
                            ...
                            case 'exact':
                                ...
                                scene.text =
                                    Math.floor(
                                        scene.flags.exactDimensions.width
                                    ) +
                                    'x' +
                                    Math.floor(
                        ...
                        var lineWrap =
                            scene.flags.lineWrap || App.setup.lineWrapRatio
                        ...
                        if (scene.flags.autoFg) {
                            ...
                            holderTextColor = holderBgColor
                                .blendAlpha(
                                    holderBgColor.lighterThan('7f7f7f')
                                        ? darkColor
                                        : lightColor
                                )
                                .toHex(true)
                        ...
                        var holderTextGroup = new Shape.Group(
                            'holderTextGroup',
                            {
                                text: scene.text,
                                align: scene.align,
                        ...
                        if (tpdata.lineCount > 1) {
                            ...
                            for (var i = 0; i < tpdata.words.length; i++) {
                                ...
                                if (
                                    !scene.noWrap &&
                                    (offsetX + word.width >= maxLineWidth ||
                                        newline === true)
                                ) {
                                    finalizeLine(
                                        holderTextGroup,
                            ...
                            if (scene.align === 'left') {
                                ...
                                for (lineKey in holderTextGroup.children) {
                                    line = holderTextGroup.children[lineKey]
                                    line.moveTo(
                                        (holderTextGroup.width - line.width) /
                                            2,
                                        null,
                                        null
                                    )
                            ...
                            if (scene.align === 'left') {
                                ...
                                holderTextGroup.moveTo(
                                    (scene.width - tpdata.boundingBox.width) /
                                        2,
                                    null,
                                    null
                                )
                    ...
                    function textSize(width, height, fontSize, scale) {
                        ...
                        var newHeight =
                            0.8 * Math.min(smallSide, bigSide * scale)
                            ...
                            if (el.holderData) {
                                ...
                                if (dimensions) {
                                    ...
                                    var settings = {
                                        ...
                                        el: el,
                                        engineSettings:
                                            el.holderData.engineSettings,
                                    }

                                    if (flags.textmode == 'exact') {
                                        flags.exactDimensions = dimensions
                                        settings.holderSettings.dimensions =
                                            flags.dimensions
                                    }
                    ...
                    function setInitialDimensions(el) {
                        if (el.holderData) {
                            ...
                            if (dimensions) {
                                ...
                                var fluidConfig = {
                                    fluidHeight:
                                        flags.dimensions.height.slice(-1) ==
                                        '%',
                                    fluidWidth:
                                        flags.dimensions.width.slice(-1) == '%',
                                    mode: null,
                                    initialDimensions: dimensions,
                                }

                                if (
                                    fluidConfig.fluidWidth &&
                                    !fluidConfig.fluidHeight
                                ) {
                    ...
                    function setInvisible(el) {
                        if (!el.holderData.invisibleId) {
                            ...
                            App.vars.invisibleImages[
                                'i' + App.vars.invisibleId
                            ] = el
                        ...
                        return function (graph) {
                            ...
                            if (App.setup.supportsSVG) {
                                ...
                                var lineCount = Math.ceil(
                                    stagingTextBBox.width /
                                        rootNode.properties.width
                                )
                                var words = htgProps.text.split(' ')
                                var newlines = htgProps.text.match(/\\n/g)
                                lineCount +=
                                    newlines == null ? 0 : newlines.length

                                //Get bounding box for the string with spaces removed
                                stagingTextNode.nodeValue =
                                    htgProps.text.replace(/[ ]+/g, '')
                                var computedNoSpaceLength =
                                    stagingText.getComputedTextLength()

                                //Compute average space width
                                var diffLength =
                                    stagingTextBBox.width -
                                    computedNoSpaceLength
                                ...
                                if (lineCount > 1) {
                                    ...
                                    for (var i = 0; i < words.length; i++) {
                                        ...
                                        stagingTextNode.nodeValue =
                                            utils.decodeHtmlEntity(words[i])
            ...
            /***/ function (module, exports) {
                ...
                module.exports =
                    typeof window !== 'undefined' && _onDomReady(window)
                ...
                /* WEBPACK VAR INJECTION */ ;(function (global) {
                    ...
                    exports.initSVG = function (svg, width, height) {
                        ...
                        for (var i = 0; i < svg.childNodes.length; i++) {
                            if (
                                svg.childNodes[i].nodeType === NODE_TYPE_COMMENT
                            ) {
                ...
                /* WEBPACK VAR INJECTION */ ;(function (global) {
                    ...
                    exports.getNodeArray = function (val) {
                        ...
                        if (typeof val == 'string') {
                            ...
                            global.NodeList &&
                            val instanceof global.NodeList
                        ) {
                            retval = val
	...
	*/
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function textCss(properties) {
                    return utils.cssProps({
                        ...
                        'font-size':
                            properties.font.size + properties.font.units,
                    })
                }
                ...
                module.exports = function (sceneGraph, renderSettings) {
                    ...
                    var css =
                        ...
                        holderId +
                        ' text { ' +
                        textCss(textGroup.properties) +
                        ' } '

                    // push text down to be equally vertically aligned with canvas renderer
                    textGroup.y +=
                        textGroup.textPositionData.boundingBox.height * 0.8
                    ...
                    if (root.children.holderBg.properties.outline) {
                        var outlineProperties =
                            root.children.holderBg.properties.outline
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                module.exports = function shaven(
                    array,
                    namespace,
                    returnObject
                ) {
