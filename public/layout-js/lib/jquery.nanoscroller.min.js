        ...
        (q = (function () {
            ...
            return (
                ...
                (j.prototype.updateScrollValues = function () {
                    ...
                    ;(a = this.content),
                        ...
                        this.iOSNativeScrolling ||
                            ((this.maxSliderTop =
                                this.paneHeight - this.sliderHeight),
                            (this.sliderTop =
                                0 === this.maxScrollTop
                                    ? 0
                ...
                (j.prototype.setOnScrollStyles = function () {
                    ...
                    B
                        ? ((a = {}),
                          (a[E] = 'translate(0, ' + this.sliderTop + 'px)'))
                    ...
                    return (
                        ...
                        0 === e && C()
                            ? ((d = b
                                  ...
                                  .replace(/[^0-9.]+/g, '')),
                              (c = checkRtl
                                  ? { left: -14, paddingLeft: +d + 14 }
                                  : { right: -14, paddingRight: +d + 14 }))
                            : e &&
                              ((c = checkRtl ? { left: -e } : { right: -e }),
                    ...
                    return this.iOSNativeScrolling
                        ...
                        : (this.$el.find('.' + this.options.paneClass).length ||
                          ...
                          l > 0 &&
                              (this.$el.height(''),
                              this.$el.height(
                                  a.scrollHeight > l ? l : a.scrollHeight
                              )),
                          ...
                          (this.pane.outerHeight(!0) >= a.scrollHeight &&
                              g !== t)
                              ? (this.pane.hide(), (this.isActive = !1))
                              : this.el.clientHeight === a.scrollHeight &&
                                g === t
                              ? this.slider.hide()
                              : this.slider.show(),
                          this.pane.css({
                ...
                (j.prototype.scroll = function () {
                    return this.isActive
                        ? ((this.sliderY = Math.max(0, this.sliderY)),
                          (this.sliderY = Math.min(
                              this.maxSliderTop,
                              this.sliderY
                          )),
                          this.$content.scrollTop(
                              (this.maxScrollTop * this.sliderY) /
                                  this.maxSliderTop
                          ),
                          this.iOSNativeScrolling ||
                ...
                (j.prototype.scrollTo = function (a) {
                    return this.isActive
                        ? (this.scrollTop(this.$el.find(a).get(0).offsetTop),
                          this)
                        : void 0
                }),
                (j.prototype.stop = function () {
                    return (
                        y &&
                            this.scrollRAF &&
                            (y(this.scrollRAF), (this.scrollRAF = null)),
                        (this.stopped = !0),
                        this.removeEvents(),
