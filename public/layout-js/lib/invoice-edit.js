...
function init_date() {
    ...
    var today =
        day + '.' + month + '.' + now.getFullYear().toString().substr(2, 2)
    ...
    var twoweeks =
        ...
        month +
        '.' +
        intwoweeks.getFullYear().toString().substr(2, 2)
...
var newRow =
    '<tr><td><a class="control removeRow" href="#">x</a><span contenteditable>Jeans</span></td><td><span contenteditable>Blue and black</span></td><td class="daterelated"><span contenteditable>Datum</span></td><td class="amount"><input type="text" value="1"/></td><td class="rate"><input type="text" value="60" /></td><td class="tax taxrelated"></td><td class="sum"></td></tr>'
