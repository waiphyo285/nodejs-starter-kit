        ...
        function (e, t, n) {
            ...
            var r = {
                    ...
                    isIOSChrome: function () {
                        return (
                            -1 !==
                            navigator.userAgent.toLowerCase().indexOf('crios')
                        )
                    },
                },
                o = r,
                        ...
                        ;(r.responseType = 'arraybuffer'),
                            ...
                            r.addEventListener('load', function () {
                                if (-1 === [200, 201].indexOf(r.status))
                                    return p(e), void e.onError(r.statusText)
                                b(e, t, r.response)
                            }),
