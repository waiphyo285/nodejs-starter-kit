        ...
        var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
            t = (_self.Prism = {
                ...
                highlightElement: function (a, r, i) {
                    ...
                    if (
                        (t.hooks.run('before-highlight', g), r && _self.Worker)
                    ) {
            ...
            return _self.addEventListener
                ? (_self.addEventListener(
                      ...
                      function (e) {
                          ...
                          _self.postMessage(
                              JSON.stringify(
                                  t.util.encode(t.tokenize(r, t.languages[a]))
                              )
                          ),
                              i && _self.close()
                      },
