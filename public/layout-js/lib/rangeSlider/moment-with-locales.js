;(function (global, factory) {
    ...
    var monthsShort$1 = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split(
        '_'
    )
    ...
    var monthsShortDot$1 =
        'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split('_')
    var monthsShort$2 = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split(
        '_'
    )
    ...
    var monthsShort$4 = 'jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec'.split(
        '_'
    )
    function plural$5(n) {
        return n > 1 && n < 5
