const status = {
    ...
    "200": {
        "code": "200",
        "message": "OK",
        "description": "တောင်းဆိုမှု အောင်မြင်သည်။",
    ...
    "201": {
        "code": "201",
        "message": "Created",
        "description": "တောင်းဆိုမှုအသစ်တစ်ခု ဖန်တီးခဲ့သည်။",
    ...
    "202": {
        "code": "202",
        "message": "Accepted",
        "description": "တောင်းဆိုချက်ကို လက်ခံပြီးဖြစ်သော်လည်း လုပ်ဆောင်ခြင်း မပြီးမြောက်ပါ။ ",
    ...
    "400": {
        "code": "400",
        "message": "Bad Request",
        "description": "တောင်းဆိုမှုသည်အကျုံးမဝင်သောကြောင့် တောင်းဆိုချက်ကို မလုပ်ဆောင်နိုင်ပါ။",
    ...
    "401": {
        ...
        "description": "တောင်းဆိုမှုသည်unauthorized ဖြစ်နေသည်။",
    ...
    "403": {
        "code": "403",
        "message": "Forbidden",
        "description": "တောင်းဆိုချက်ကိုနားလည်သော်လည်း ခွင့်ပြုရန် ငြင်းဆိုသည်။",
    ...
    "404": {
        "code": "404",
        "message": "Not Found",
        "description": "တောင်းဆိုမှုကို မတွေ့ရှိပါ။",
    ...
    "405": {
        ...
        "description": "တောင်းဆိုထားသောmethodကို ခွင့်မပြုပါ။",
    ...
    "503": {
        ...
        "description": "တောင်းဆိုချက်ကိုလက်တလော မလုပ်ဆောင်နိုင်ပါ။",
    ...
    "504": {
        ...
        "description": "တစ်စုံတစ်ခုမှာယွင်းမှုကြောင့် တောင်းဆိုချက်ကို မလုပ်ဆောင်နိုင်ပါ။",
